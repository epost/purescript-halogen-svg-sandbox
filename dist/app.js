...
(function(exports) {
  ...
  var Unsafe_Coerce = PS["Unsafe.Coerce"];
  var Hours = (function () {
      function Hours(value0) {
          this.value0 = value0;
      };
      Hours.create = function (value0) {
          return new Hours(value0);
      };
      return Hours;
  })();
  var Minutes = (function () {
      function Minutes(value0) {
          this.value0 = value0;
      };
      Minutes.create = function (value0) {
          return new Minutes(value0);
      };
      return Minutes;
  })();
  ...
  var Millis = (function () {
      function Millis(value0) {
          this.value0 = value0;
      };
      Millis.create = function (value0) {
          return new Millis(value0);
      };
      return Millis;
  })();
  ...
  var printDuration = function (v) {
      if (v instanceof Hours) {
          return Data_Show.show(Data_Show.showNumber)(v.value0) + "h";
      };
      if (v instanceof Minutes) {
          return Data_Show.show(Data_Show.showNumber)(v.value0) + "m";
      };
      if (v instanceof Seconds) {
          return Data_Show.show(Data_Show.showNumber)(v.value0) + "s";
      };
      if (v instanceof Millis) {
          return Data_Show.show(Data_Show.showNumber)(v.value0) + "i";
      };
      if (v instanceof Duration) {
          return "TODO";
      };
      throw new Error("Failed pattern match at Svg.Attributes line 268, column 17 - line 276, column 1: " + [ v.constructor.name ]);
  };
  var printCommand = function (v) {
      ...
      throw new Error("Failed pattern match at Svg.Attributes line 137, column 1 - line 137, column 65: " + [ v.constructor.name ]);
  };
  var printD = function (v) {
      ...
      throw new Error("Failed pattern match at Svg.Attributes line 121, column 1 - line 121, column 22: " + [ v.constructor.name ]);
  };
  ...
  var cx = function ($99) {
      return attr("cx")(Data_Show.show(Data_Show.showNumber)($99));
  };
  var cy = function ($100) {
      return attr("cy")(Data_Show.show(Data_Show.showNumber)($100));
  };
  var d = function ($101) {
      return attr("d")(Data_String_Common.joinWith(" ")(Data_Functor.map(Data_Functor.functorArray)(printD)($101)));
  };
  var dur = function ($103) {
      return attr("dur")(printDuration($103));
  };
  var fill = function ($104) {
      return attr("fill")(printColor($104));
  };
  var fill_freeze = attr("fill");
  var from = attr("from");
  var id = attr("id");
  var r = function ($107) {
      return attr("r")(Data_Show.show(Data_Show.showNumber)($107));
  };
  var repeatCount = function ($108) {
      return attr("repeatCount")(Data_Show.show(Data_Show.showInt)($108));
  };
  var stroke = function ($111) {
      return attr("stroke")(printColor($111));
  };
  var to = attr("to");
  ...
  exports["fill_freeze"] = fill_freeze;
...
(function(exports) {
  ...
  var svg = element("svg");  
  var circleWithKids = element("circle");
  ...
  exports["circleWithKids"] = circleWithKids;
  exports["mpath"] = mpath;
...
(function(exports) {
  ...
  var trajectoryWithAnimatedCircle = function (trajectoryId) {
      return function (startPos) {
          return function (endPos) {
              var svgPath = Svg_Elements.path([ Svg_Attributes.id(trajectoryId), Svg_Attributes.d(Data_Functor.map(Data_Functor.functorArray)(Svg_Attributes.Abs.create)([ new Svg_Attributes.M(startPos.x, startPos.y), new Svg_Attributes.L(endPos.x, endPos.y) ])), Svg_Attributes.stroke(new Data_Maybe.Just(new Svg_Attributes.RGB(200, 200, 200))) ]);
              var animatedCircle = (function () {
                  var animationId = trajectoryId + "_animation";
                  return Svg_Elements.circleWithKids([ Svg_Attributes.cx(0.0), Svg_Attributes.cy(0.0), Svg_Attributes.r(3.0), Svg_Attributes.class_("le_circle"), Svg_Attributes.fill(new Data_Maybe.Just(new Svg_Attributes.RGB(255, 255, 0))), Svg_Attributes.stroke(new Data_Maybe.Just(new Svg_Attributes.RGB(150, 150, 150))) ])([ Svg_Elements.animateMotion([ Svg_Attributes.id(animationId), Svg_Attributes.dur(new Svg_Attributes.Seconds(1.0)), Svg_Attributes.begin("indefinite"), Svg_Attributes.repeatCount(1) ])([ Svg_Elements.mpath([ Svg_Attributes.xlinkHref("#" + trajectoryId) ]) ]), Svg_Elements.animate([ Svg_Attributes.dur(new Svg_Attributes.Seconds(0.25)), Svg_Attributes.attributeName("r"), Svg_Attributes.from("0.0"), Svg_Attributes.to("3.0"), Svg_Attributes.begin(animationId + ".begin"), Svg_Attributes.repeatCount(0), Svg_Attributes.fill_freeze("freeze") ]) ]);
              })();
              return Svg_Elements.g([  ])([ svgPath, animatedCircle ]);
          };
      };
  };
  var leViewBox = (function () {
      var bounds = {
          min: {
              x: 10.0,
              y: 30.0
      ...
      var sceneHeight = (bounds.max.y - bounds.min.y) + 32.0;
      var sceneLeft = bounds.min.x - 32.0 / 2.0;
      var sceneTop = bounds.min.y - 32.0 / 2.0;
      var sceneWidth = (bounds.max.x - bounds.min.x) + 32.0;
      return Svg_Attributes.viewBox(sceneLeft)(sceneTop)(sceneWidth)(sceneHeight);
  })();
  var $$eval = function (v) {
  ...
  var ui = function (initialState) {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "copy-me" ]) ])([ Svg_Elements.svg([ leViewBox ])([ trajectoryWithAnimatedCircle("tr_100")({
              x: 10.0,
              y: 30.0
          })({
              x: 70.0,
  ...
  exports["ui"] = ui;
  exports["trajectoryWithAnimatedCircle"] = trajectoryWithAnimatedCircle;
  exports["leViewBox"] = leViewBox;
})(PS["SvgAnimateMotion1"] = PS["SvgAnimateMotion1"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var Prelude = PS["Prelude"];
  var SvgAnimateMotion1 = PS["SvgAnimateMotion1"];                 
  var initialState = {
      msg: ""
  };
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(SvgAnimateMotion1.ui(initialState))(Data_Unit.unit)(v);
  }));
